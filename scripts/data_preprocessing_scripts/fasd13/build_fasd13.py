...
Not to be confused with ``esp_data.datasets.drasdic`` -- that is the *synthetic
training* corpus from the same paper. FASD13 shares no audio with it.
...
Stages (run in order by ``build_fasd13.sh`` on Slurm CPU):
